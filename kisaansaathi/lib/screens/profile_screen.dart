...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadFarmerData() async {
    ...
    try {
      ...
      // FIXED: Use consistent key
      final farmerString =
          prefs.getString('farmer') ?? prefs.getString('farmerData');
      final token = prefs.getString('token');
      ...
      if (farmerString != null) {
        ...
        if (token != null && farmer['phoneNumber'] != null) {
          try {
            final result = await FarmerService.getFarmerByPhone(
              farmer['phoneNumber'],
            );
            if (result.success && result.data != null) {
              final data = result.data!;
                          ...
                          children: [
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 4),
                                    Text(
                                      FarmerIdUtils.maskFarmerId(
                                        _farmerData!['farmerId'].toString(),
                                      ),
                                      style: const TextStyle(
                                        fontSize: 16,
                                        fontWeight: FontWeight.bold,
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                keyboardType: TextInputType.phone,
                                readOnly:
                                    true, // Phone number cannot be changed
                              ),
                            ),
                            const SizedBox(height: 40),
                            ...
                            SizedBox(
                              ...
                              child: OutlinedButton.icon(
                                onPressed: () async {
                                  // Reset tutorial and navigate to onboarding
