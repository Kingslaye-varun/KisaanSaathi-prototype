...
class AppLocalizations {
  ...
  String get lessThan1Acre {
    switch (locale.languageCode) {
      case 'ml':
        return '1 ഏക്കറിൽ താഴെ';
      case 'kn':
        return '1 ಎಕರೆಗಿಂತ ಕಡಿಮೆ';
      case 'hi':
        return '1 एकड़ से कम';
      case 'pa':
        return '1 ਏਕੜ ਤੋਂ ਘੱਟ';
      case 'bn':
        return '১ একরের কম';
      case 'gu':
        return '1 એકરથી ઓછું';
      case 'mr':
        return '1 एकरपेक्षा कमी';
      case 'te':
        return '1 ఎకరా కంటే తక్కువ';
      case 'ta':
        return '1 ஏக்கருக்கு குறைவாக';
      case 'en':
        return 'Less than 1 Acre';
      default:
        return 'Less than 1 Acre';
    }
  }
  ...
  String get oneToFiveAcres {
    switch (locale.languageCode) {
      case 'ml':
        return '1 മുതൽ 5 ഏക്കർ വരെ';
      case 'kn':
        return '1 ರಿಂದ 5 ಎಕರೆಗಳವರೆಗೆ';
      case 'hi':
        return '1 से 5 एकड़ तक';
      case 'pa':
        return '1 ਤੋਂ 5 ਏਕੜ ਤੱਕ';
      case 'bn':
        return '১ থেকে ৫ একর পর্যন্ত';
      case 'gu':
        return '1 થી 5 એકર સુધી';
      case 'mr':
        return '1 ते 5 एकरांपर्यंत';
      case 'te':
        return '1 నుండి 5 ఎకరాల వరకు';
      case 'ta':
        return '1 முதல் 5 ஏக்கர் வரை';
      case 'en':
        return '1 to 5 Acres';
      default:
        return '1 to 5 Acres';
  ...
  String get fiveToTenAcres {
    switch (locale.languageCode) {
      case 'ml':
        return '5 മുതൽ 10 ഏക്കർ വരെ';
      case 'kn':
        return '5 ರಿಂದ 10 ಎಕರೆಗಳವರೆಗೆ';
      case 'hi':
        return '5 से 10 एकड़ तक';
      case 'pa':
        return '5 ਤੋਂ 10 ਏਕੜ ਤੱਕ';
      case 'bn':
        return '৫ থেকে ১০ একর পর্যন্ত';
      case 'gu':
        return '5 થી 10 એકર સુધી';
      case 'mr':
        return '5 ते 10 एकरांपर्यंत';
      case 'te':
        return '5 నుండి 10 ఎకరాల వరకు';
      case 'ta':
        return '5 முதல் 10 ஏக்கர் வரை';
      case 'en':
  ...
  String get moreThanTenAcres {
    switch (locale.languageCode) {
      case 'ml':
        return '10 ഏക്കറിൽ കൂടുതൽ';
      case 'kn':
        return '10 ಎಕರೆಗಿಂತ ಹೆಚ್ಚು';
      case 'hi':
        return '10 एकड़ से अधिक';
      case 'pa':
        return '10 ਏਕੜ ਤੋਂ ਵੱਧ';
      case 'bn':
        return '১০ একরের বেশি';
      case 'gu':
        return '10 એકરથી વધુ';
      case 'mr':
        return '10 एकरांपेक्षा जास्त';
      case 'te':
        return '10 ఎకరాలకు మించి';
      case 'ta':
        return '10 ஏக்கருக்கு மேல்';
      case 'en':
        return 'More than 10 Acres';
      default:
        return 'More than 10 Acres';
    }
  }
  ...
  String get chooseFromGallery {
    switch (locale.languageCode) {
      case 'ml':
        return 'ഗാലറിയിൽ നിന്ന് തിരഞ്ഞെടുക്കുക'; // Malayalam
      case 'kn':
        return 'ಗ್ಯಾಲರಿಯಿಂದ ಆಯ್ಕೆಮಾಡಿ'; // Kannada
      case 'hi':
        return 'गैलरी से चुनें'; // Hindi
      case 'pa':
        return 'ਗੈਲਰੀ ਵਿਚੋਂ ਚੁਣੋ'; // Punjabi
      case 'bn':
        return 'গ্যালারি থেকে বেছে নিন'; // Bengali
      case 'gu':
        return 'ગેલેરીમાંથી પસંદ કરો'; // Gujarati
      case 'mr':
        return 'गॅलरीतून निवडा'; // Marathi
      case 'te':
        return 'గ్యాలరీ నుండి ఎంచుకోండి'; // Telugu
      case 'ta':
        return 'கேலரியிலிருந்து தேர்ந்தெடுக்கவும்'; // Tamil
      default:
  ...
  String get plantDiseaseDetection {
    switch (locale.languageCode) {
      case 'ml':
        return 'സസ്യരോഗം കണ്ടെത്തൽ';
      case 'kn':
        return 'ಸಸ್ಯರೋಗ ಪತ್ತೆಹಚ್ಚು';
      case 'hi':
        return 'पौधों की बीमारी का पता लगाएं';
      case 'pa':
        return 'ਪੌਦੇ ਦੀ ਬਿਮਾਰੀ ਦੀ ਪਛਾਣ';
      case 'bn':
        return 'উদ্ভিদের রোগ শনাক্তকরণ';
      case 'gu':
        return 'વનસ્પતિ રોગ શોધ';
      case 'mr':
        return 'वनस्पती रोग शोध';
      case 'te':
        return 'మొక్కల వ్యాధి గుర్తింపు';
      case 'ta':
        return 'தாவர நோய் கண்டறிதல்';
      default:
        return 'Plant Disease Detection';
    }
  }
  ...
  String get tapToSelectPlantImage {
    switch (locale.languageCode) {
      case 'ml':
        return 'സസ്യത്തിന്റെ ചിത്രം തിരഞ്ഞെടുക്കാൻ ടാപ്പ് ചെയ്യുക';
      case 'kn':
        return 'ಸಸ್ಯದ ಚಿತ್ರವನ್ನು ಆಯ್ಕೆಮಾಡಲು ಟ್ಯಾಪ್ ಮಾಡಿ';
      case 'hi':
        return 'पौधे की छवि चुनने के लिए टैप करें';
      case 'pa':
        return 'ਪੌਦੇ ਦੀ ਤਸਵੀਰ ਚੁਣਨ ਲਈ ਟੈਪ ਕਰੋ';
      case 'bn':
        return 'গাছের ছবি বেছে নিতে ট্যাপ করুন';
      case 'gu':
        return ' છોડની છબી પસંદ કરવા માટે ટેપ કરો';
      case 'mr':
        return 'वनस्पतीचे चित्र निवडण्यासाठी टॅप करा';
      case 'te':
        return 'మొక్క చిత్రాన్ని ఎంచుకోవడానికి ట్యాప్ చేయండి';
      case 'ta':
        return 'தாவரப் படத்தைத் தேர்ந்தெடுக்க தட்டவும்';
      default:
        return 'Tap to select plant image';
    }
  }
  ...
  String get detectingDisease {
    switch (locale.languageCode) {
      case 'ml':
        return 'രോഗം കണ്ടെത്തുന്നു...';
      case 'kn':
        return 'ರೋಗವನ್ನು ಪತ್ತೆಹಚ್ಚಲಾಗುತ್ತಿದೆ...';
      case 'hi':
        return 'रोग का पता लगाया जा रहा है...';
      case 'pa':
        return 'ਬਿਮਾਰੀ ਦੀ ਪਛਾਣ ਹੋ ਰਹੀ ਹੈ...';
      case 'bn':
        return 'রোগ সনাক্ত করা হচ্ছে...';
      case 'gu':
        return 'રોગ શોધી રહ્યા છીએ...';
      case 'mr':
        return 'रोग शोधला जात आहे...';
      case 'te':
        return 'వ్యాధిని గుర్తిస్తోంది...';
      case 'ta':
        return 'நோயை கண்டறிகிறது...';
      default:
        return 'Detecting disease...';
    }
  }
  ...
  String get changeImage {
    switch (locale.languageCode) {
      case 'ml':
        return 'ചിത്രം മാറ്റുക';
      case 'kn':
        return 'ಚಿತ್ರವನ್ನು ಬದಲಿಸಿ';
      case 'hi':
        return 'छवि बदलें';
      case 'pa':
        return 'ਤਸਵੀਰ ਬਦਲੋ';
      case 'bn':
        return 'ছবি পরিবর্তন করুন';
      case 'gu':
        return 'છબી બદલો';
      case 'mr':
        return 'प्रतिमा बदला';
      case 'te':
        return 'చిత్రాన్ని మార్చండి';
      case 'ta':
        return 'படத்தை மாற்றவும்';
      default:
        return 'Change Image';
    }
  }
  ...
  String get typeMessage {
    switch (locale.languageCode) {
      case 'ml':
        return 'നിങ്ങളുടെ കൃഷി ചോദ്യം ടൈപ്പ് ചെയ്യുക...';
      case 'kn':
        return 'ನಿಮ್ಮ ಕೃಷಿ ಪ್ರಶ್ನೆಯನ್ನು ಟೈಪ್ ಮಾಡಿ...';
      case 'hi':
        return 'अपना कृषि प्रश्न टाइप करें...';
      case 'pa':
        return 'ਆਪਣਾ ਖੇਤੀਬਾੜੀ ਸਵਾਲ ਟਾਈਪ ਕਰੋ...';
      case 'bn':
        return 'আপনার কৃষি প্রশ্ন টাইপ করুন...';
      case 'gu':
        return 'તમારો કૃષિ પ્રશ્ન લખો...';
      case 'mr':
        return 'आपला शेतीचा प्रश्न टाइप करा...';
      case 'te':
        return 'మీ వ్యవసాయ ప్రశ్నను టైప్ చేయండి...';
      case 'ta':
        return 'உங்கள் விவசாய கேள்வியை தட்டச்சு செய்யவும்...';
      default:
        return 'Type your farming query...';
    }
  }
  ...
  String get findNearbyStorage {
    switch (locale.languageCode) {
      case 'ml':
        return 'സമീപമുള്ള സംഭരണ ​​കേന്ദ്രങ്ങൾ കണ്ടെത്തുന്നു...';
      case 'kn':
        return 'ಸಮೀಪದ ಸಂಗ್ರಹಣಾ ಕೇಂದ್ರಗಳನ್ನು ಹುಡುಕಲಾಗುತ್ತಿದೆ...';
      case 'hi':
        return 'निकटवर्ती भंडारण केंद्र खोज रहे हैं...';
      case 'pa':
        return 'ਨੇੜਲੇ ਸਟੋਰੇਜ ਕੇਂਦਰ ਲੱਭੇ ਜਾ ਰਹੇ ਹਨ...';
      case 'bn':
        return 'নিকটবর্তী সংরক্ষণ কেন্দ্রগুলি খোঁজা হচ্ছে...';
      case 'gu':
        return 'નજીકના સ્ટોરેજ સેન્ટરો શોધી રહ્યા છીએ...';
      case 'mr':
        return 'जवळील साठवण केंद्रे शोधत आहे...';
      case 'te':
        return 'సమీపంలోని నిల్వ కేంద్రాలను కనుగొంటోంది...';
      case 'ta':
        return 'அருகிலுள்ள சேமிப்பு மையங்களை கண்டறிதல்...';
      default:
        return 'Finding nearby storage centers...';
    }
  }
  ...
  String get coldStorage {
    switch (locale.languageCode) {
      case 'ml':
        return 'കൊൾഡ് സ്റ്റോറേജ്';
      case 'kn':
        return 'ಕೋಲ್ಡ್ ಸ್ಟೋರೇಜ್';
      case 'hi':
        return 'कोल्ड स्टोरेज';
      case 'pa':
        return 'ਠੰਢਾ ਸਟੋਰੇਜ';
      case 'bn':
        return 'কোল্ড স্টোরেজ';
      case 'gu':
        return 'ઠંડુ સ્ટોરેજ';
      case 'mr':
        return 'कोल्ड स्टोरेज';
  ...
  String get refrigeratedStorage {
    switch (locale.languageCode) {
      case 'ml':
        return 'തണുപ്പിച്ച സംഭരണം';
      case 'kn':
        return 'ಶೀತಲೀಕೃತ ಸಂಗ್ರಹಣೆ';
      case 'hi':
        return 'शीत भंडारण';
      case 'pa':
        return 'ਠੰਢਾ ਸਟੋਰੇਜ';
      case 'bn':
        return 'রেফ্রিজারেটেড স্টোরেজ';
      case 'gu':
        return 'શીતળ સ્ટોરેજ';
      case 'mr':
        return 'शीतगृह';
      case 'te':
        return 'ఫ్రిజ్ నిల్వ';
      case 'ta':
        return 'குளிரூட்டப்பட்ட சேமிப்பு';
      default:
  ...
  String get agriculturalStorage {
    switch (locale.languageCode) {
      case 'ml':
        return 'കൃഷി സംഭരണം';
      case 'kn':
        return 'ಕೃಷಿ ಸಂಗ್ರಹಣೆ';
      case 'hi':
        return 'कृषि भंडारण';
      case 'pa':
        return 'ਕ੍ਰਿਸ਼ੀ ਸਟੋਰੇਜ';
      case 'bn':
        return 'কৃষি সংরক্ষণ';
      case 'gu':
        return 'કૃષિ સંગ્રહ';
      case 'mr':
        return 'कृषी साठवण';
      case 'te':
        return 'వ్యవసాయ నిల్వ';
      case 'ta':
        return 'விவசாய சேமிப்பு';
      default:
        return 'Agricultural Storage';
    }
  }
  ...
  String get showingStorageWithRadius {
    switch (locale.languageCode) {
      case 'ml':
        return 'നിർദ്ദിഷ്ട പരിധിയിലുള്ള സംഭരണങ്ങൾ പ്രദർശിപ്പിക്കുന്നു';
      case 'kn':
        return 'ನಿರ್ದಿಷ್ಟ ವ್ಯಾಪ್ತಿಯೊಳಗಿನ ಸಂಗ್ರಹಣೆಯನ್ನು ತೋರಿಸಲಾಗುತ್ತಿದೆ';
      case 'hi':
        return 'निर्दिष्ट सीमा के भीतर भंडारण दिखा रहा है';
      case 'pa':
        return 'ਨਿਰਧਾਰਤ ਹੱਦ ਵਿੱਚ ਸਟੋਰੇਜ ਦਿਖਾਇਆ ਜਾ ਰਿਹਾ ਹੈ';
      case 'bn':
        return 'নির্দিষ্ট সীমার মধ্যে স্টোরেজ দেখানো হচ্ছে';
      case 'gu':
        return 'નિર્ધારિત વ્યાસની અંદર સ્ટોરેજ બતાવી રહ્યું છે';
      case 'mr':
        return 'निर्धारित त्रिज्येतील साठवण दाखवत आहे';
      case 'te':
        return 'నిర్దిష్ట పరిధిలో నిల్వను చూపుతోంది';
      case 'ta':
        return 'குறிப்பிட்ட ஆரை உள்ளே சேமிப்பைக் காட்டுகிறது';
      default:
        return 'Showing storage within specified radius';
    }
  }
  ...
  String get cropTraderFinder {
    switch (locale.languageCode) {
      case 'ml':
        return 'വിള വ്യാപാരിയെ കണ്ടെത്തുക';
      case 'kn':
        return 'ಬೆಳೆ ವ್ಯಾಪಾರಿಯನ್ನು ಹುಡುಕಿ';
      case 'hi':
        return 'फसल व्यापारी खोजें';
      case 'pa':
        return 'ਫਸਲ ਵਪਾਰੀ ਲੱਭੋ';
      case 'bn':
        return 'ফসল ব্যবসায়ী খুঁজুন';
      case 'gu':
        return 'પાક વેપારી શોધો';
      case 'mr':
        return 'पिक व्यापारी शोधा';
      case 'te':
        return 'పంట వ్యాపారిని కనుగొనండి';
      case 'ta':
        return 'பயிர் வர்த்தகரை கண்டறியவும்';
      default:
        return 'Crop Trader Finder';
    }
  }
  ...
  String get findNearbyTraders {
    switch (locale.languageCode) {
      case 'ml':
        return 'അടുത്ത വിള വ്യാപാരികളെ കണ്ടെത്തുക!';
      case 'kn':
        return 'ಹತ್ತಿರದ ಬೆಳೆ ವ್ಯಾಪಾರಿಗಳನ್ನು ಹುಡುಕಿ!';
      case 'hi':
        return 'नज़दीकी फसल व्यापारियों को खोजें!';
      case 'pa':
        return 'ਨੇੜਲੇ ਫਸਲ ਵਪਾਰੀਆਂ ਨੂੰ ਲੱਭੋ!';
      case 'bn':
        return 'নিকটবর্তী ফসল ব্যবসায়ীদের খুঁজুন!';
      case 'gu':
        return 'નજીકના પાક વેપારીઓ શોધો!';
      case 'mr':
        return 'जवळचे पिक व्यापारी शोधा!';
      case 'te':
        return 'సమీపంలోని పంట వ్యాపారులను కనుగొనండి!';
      case 'ta':
        return 'அருகிலுள்ள பயிர் வர்த்தகர்களைக் கண்டறியவும்!';
      default:
        return 'Find nearby crop traders!';
    }
  }
  ...
  String get commissionAgent {
    switch (locale.languageCode) {
      case 'ml':
        return 'കമ്മീഷൻ ഏജന്റ്';
      case 'kn':
        return 'ಕಮಿಷನ್ ಏಜೆಂಟ್';
      case 'hi':
        return 'कमीशन एजेंट';
      case 'pa':
        return 'ਕਮਿਸ਼ਨ ਏਜੰਟ';
      ...
      case 'mr':
        return 'कमिशन एजंट';
      case 'te':
        return 'కమీషన్ ఏజెంట్';
      case 'ta':
        return 'கமிஷன் ஏஜென்ட்';
      default:
  ...
  String get mandiTrader {
    switch (locale.languageCode) {
      case 'ml':
        return 'മണ്ഡി വ്യാപാരി';
      case 'kn':
        return 'ಮಂಡಿ ವ್ಯಾಪಾರಿ';
      case 'hi':
        return 'मंडी व्यापारी';
      case 'pa':
        return 'ਮੰਡੀ ਵਪਾਰੀ';
      case 'bn':
        return 'মান্ডি ব্যবসায়ী';
      case 'gu':
        return 'મંડી વેપારી';
      case 'mr':
        return 'मंडी व्यापारी';
      case 'te':
        return 'మండి వ్యాపారి';
      case 'ta':
        return 'மண்டி வர்த்தகர்';
      default:
        return 'Mandi Trader';
    }
  }
  ...
  String get bulkBuyer {
    switch (locale.languageCode) {
      case 'ml':
        return 'മൊത്ത വാങ്ങുന്നവർ';
      case 'kn':
        return 'ಬೃಹತ್ ಖರೀದಿದಾರ';
      case 'hi':
        return 'थोक खरीदार';
      case 'pa':
        return 'ਥੋਕ ਖਰੀਦਦਾਰ';
      ...
      case 'gu':
        return 'બલ્ક ખરીદદાર';
      case 'mr':
        return 'मोठ्या प्रमाणात खरेदीदार';
      case 'te':
        return 'బల్క్ కొనుగోలుదారు';
      case 'ta':
        return 'மொத்த வாங்குபவர்';
      default:
        return 'Bulk Buyer';
    }
  }
  ...
  String get exportTrader {
    switch (locale.languageCode) {
      case 'ml':
        return 'കയറ്റുമതി വ്യാപാരി';
      case 'kn':
        return 'ರಫ್ತು ವ್ಯಾಪಾರಿ';
      case 'hi':
        return 'निर्यात व्यापारी';
      case 'pa':
        return 'ਨਿਰਯਾਤ ਵਪਾਰੀ';
      case 'bn':
        return 'রপ্তানি ব্যবসায়ী';
      case 'gu':
        return 'નિકાસ વેપારી';
      case 'mr':
        return 'निर्यात व्यापारी';
      case 'te':
        return 'ఎగుమతి వ్యాపారి';
      case 'ta':
        return 'ஏற்றுமதி வர்த்தகர்';
      default:
        return 'Export Trader';
    }
  }
  ...
  String get processingUnit {
    switch (locale.languageCode) {
      case 'ml':
        return 'സംസ്കരണ യൂണിറ്റ്';
      case 'kn':
        return 'ಸಂಸ್ಕರಣಾ ಘಟಕ';
      case 'hi':
        return 'प्रसंस्करण इकाई';
      case 'pa':
        return 'ਪ੍ਰੋਸੈਸਿੰਗ ਯੂਨਿਟ';
      case 'bn':
        return 'প্রক্রিয়াকরণ ইউনিট';
      case 'gu':
        return 'પ્રોસેસિંગ યુનિટ';
      case 'mr':
        return 'प्रक्रिया युनिट';
      case 'te':
        return 'ప్రాసెసింగ్ యూనిట్';
      case 'ta':
        return 'செயலாக்க அலகு';
      default:
  ...
  String get cooperativeSociety {
    switch (locale.languageCode) {
      ...
      case 'hi':
        return 'सहकारी समिति';
      case 'pa':
        return 'ਸਹਿਕਾਰੀ ਸੋਸਾਇਟੀ';
      case 'bn':
        return 'সমবায় সমিতি';
      case 'gu':
        return 'સહકારી સંસ્થા';
      case 'mr':
        return 'सहकारी संस्था';
      case 'te':
        return 'సహకార సంఘం';
      case 'ta':
        return 'கூட்டுறவு சங்கம்';
      default:
  ...
  String get findTraders {
    switch (locale.languageCode) {
      case 'ml':
        return 'വ്യാപാരികളെ കണ്ടെത്തുക';
      case 'kn':
        return 'ವ್ಯಾಪಾರಿಗಳನ್ನು ಹುಡುಕಿ';
      case 'hi':
        return 'व्यापारी खोजें';
      case 'pa':
        return 'ਵਪਾਰੀ ਲੱਭੋ';
      case 'bn':
        return 'ব্যবসায়ী খুঁজুন';
      case 'gu':
        return 'વેપારીઓ શોધો';
      case 'mr':
        return 'व्यापारी शोधा';
      case 'te':
        return 'వ్యాపారులను కనుగొనండి';
      case 'ta':
        return 'வர்த்தகர்களைக் கண்டறியவும்';
      default:
        return 'Find Traders';
    }
  }
  ...
  String get locatingPosition {
    switch (locale.languageCode) {
      case 'ml':
        return 'നിങ്ങളുടെ സ്ഥാനം കണ്ടെത്തുന്നു...';
      case 'kn':
        return 'ನಿಮ್ಮ ಸ್ಥಾನವನ್ನು ಪತ್ತೆಹಚ್ಚಲಾಗುತ್ತಿದೆ...';
      case 'hi':
        return 'आपकी स्थिति का पता लगाया जा रहा है...';
      case 'pa':
        return 'ਤੁਹਾਡੀ ਸਥਿਤੀ ਲੱਭੀ ਜਾ ਰਹੀ ਹੈ...';
      case 'bn':
        return 'আপনার অবস্থান খুঁজে বের করা হচ্ছে...';
      case 'gu':
        return 'તમારી સ્થિતિ શોધી રહ્યા છીએ...';
      case 'mr':
        return 'तुमची स्थिती शोधत आहे...';
      case 'te':
        return 'మీ స్థానాన్ని గుర్తిస్తోంది...';
      case 'ta':
        return 'உங்கள் இருப்பிடத்தைக் கண்டறிகிறது...';
      default:
  ...
  String get enableLocationServices {
    switch (locale.languageCode) {
      case 'ml':
        return 'ദയവായി ലൊക്കേഷൻ സേവനങ്ങൾ പ്രവർത്തനക്ഷമമാക്കുക';
      case 'kn':
        return 'ದಯವಿಟ್ಟು ಸ್ಥಳ ಸೇವೆಗಳನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಿ';
      case 'hi':
        return 'कृपया लोकेशन सेवाएं सक्षम करें';
      case 'pa':
        return 'ਕਿਰਪਾ ਕਰਕੇ ਟਿਕਾਣਾ ਸੇਵਾਵਾਂ ਸਮਰੱਥ ਕਰੋ';
      case 'bn':
        return 'অনুগ্রহ করে অবস্থান পরিষেবা সক্ষম করুন';
      case 'gu':
        return 'કૃપા કરીને સ્થાન સેવાઓ સક્ષમ કરો';
      case 'mr':
        return 'कृपया स्थान सेवा सक्षम करा';
      case 'te':
        return 'దయచేసి స్థాన సేవలను ప్రారంభించండి';
      case 'ta':
        return 'இருப்பிட சேவைகளை இயக்கவும்';
      default:
  ...
  String get locationPermissionsDenied {
    switch (locale.languageCode) {
      case 'ml':
        return 'ലൊക്കേഷൻ അനുമതികൾ സ്ഥിരമായി നിരസിച്ചു. ആപ്പ് ക്രമീകരണങ്ങളിൽ പ്രവർത്തനക്ഷമമാക്കുക.';
      case 'kn':
        return 'ಸ್ಥಳ ಅನುಮತಿಗಳನ್ನು ಶಾಶ್ವತವಾಗಿ ನಿರಾಕರಿಸಲಾಗಿದೆ. ಆ್ಯಪ್ ಸೆಟ್ಟಿಂಗ್‌ಗಳಲ್ಲಿ ಸಕ್ರಿಯಗೊಳಿಸಿ.';
      case 'hi':
        return 'लोकेशन अनुमतियाँ स्थायी रूप से अस्वीकृत। कृपया ऐप सेटिंग्स में सक्षम करें।';
      case 'pa':
        return 'ਟਿਕਾਣਾ ਅਨੁਮਤੀਆਂ ਸਥਾਈ ਤੌਰ ਤੇ ਇਨਕਾਰ ਕੀਤੀਆਂ ਗਈਆਂ। ਐਪ ਸੈਟਿੰਗਾਂ ਵਿੱਚ ਸਮਰੱਥ ਕਰੋ।';
      case 'bn':
        return 'অবস্থান অনুমতি স্থায়ীভাবে প্রত্যাখ্যান করা হয়েছে। অনুগ্রহ করে অ্যাপ সেটিংসে সক্ষম করুন।';
      case 'gu':
        return 'સ્થાન પરવાનગીઓ કાયમી રીતે નકારવામાં આવી છે. કૃપા કરીને એપ સેટિંગ્સમાં સક્ષમ કરો.';
      case 'mr':
        return 'स्थान परवानग्या कायमची नाकारल्या. कृपया अॅप सेटिंग्जमध्ये सक्षम करा.';
      case 'te':
        return 'స్థాన అనుమతులు శాశ్వతంగా తిరస్కరించబడ్డాయి. దయచేసి యాప్ సెట్టింగ్‌లలో ప్రారంభించండి.';
      case 'ta':
        return 'இருப்பிட அனுமதிகள் நிரந்தரமாக மறுக்கப்பட்டன. பயன்பாட்டு அமைப்புகளில் இயக்கவும்.';
      default:
        return 'Location permissions permanently denied. Please enable in app settings.';
    }
  }
  ...
  String get locationPermissionsRequired {
    switch (locale.languageCode) {
      case 'ml':
        return 'ലൊക്കേഷൻ അനുമതികൾ ആവശ്യമാണ്';
      case 'kn':
        return 'ಸ್ಥಳ ಅನುಮತಿಗಳು ಅಗತ್ಯವಿದೆ';
      case 'hi':
        return 'लोकेशन अनुमतियाँ आवश्यक हैं';
      case 'pa':
        return 'ਟਿਕਾਣਾ ਅਨੁਮਤੀਆਂ ਲੋੜੀਂਦੀਆਂ ਹਨ';
      case 'bn':
        return 'অবস্থান অনুমতি প্রয়োজন';
      case 'gu':
        return 'સ્થાન પરવાનગીઓ જરૂરી છે';
      case 'mr':
        return 'स्थान परवानग्या आवश्यक आहेत';
      case 'te':
        return 'స్థాన అనుమతులు అవసరం';
      case 'ta':
        return 'இருப்பிட அனுமதிகள் தேவை';
      default:
  ...
  String get findingNearbyTraders {
    switch (locale.languageCode) {
      case 'ml':
        return 'അടുത്തുള്ള വ്യാപാരികളെ കണ്ടെത്തുന്നു...';
      case 'kn':
        return 'ಹತ್ತಿರದ ವ್ಯಾಪಾರಿಗಳನ್ನು ಹುಡುಕುತ್ತಿದೆ...';
      case 'hi':
        return 'पास के व्यापारी खोज रहे हैं...';
      case 'pa':
        return 'ਨੇੜੇ ਦੇ ਵਪਾਰੀ ਲੱਭ ਰਹੇ ਹਾਂ...';
      case 'bn':
        return 'কাছাকাছি ব্যবসায়ী খুঁজছি...';
      case 'gu':
        return 'નજીકના વેપારીઓ શોધી રહ્યા છીએ...';
      case 'mr':
        return 'जवळचे व्यापारी शोधत आहे...';
      case 'te':
        return 'సమీపంలో ఉన్న వ్యాపారులను కనుగొంటోంది...';
      case 'ta':
        return 'அருகிலுள்ள வர்த்தகர்களைத் தேடுகிறது...';
      default:
        return 'Finding nearby traders...';
    }
  }
  ...
  String showingTraders(String traderType, int radius) {
    switch (locale.languageCode) {
      case 'ml':
        return '$radius കിലോമീറ്ററിനുള്ളിൽ $traderType കാണിക്കുന്നു';
      case 'kn':
        return '$radius ಕಿಲೋಮೀಟರ್‌ಗಳಲ್ಲಿ $traderType ತೋರಿಸಲಾಗುತ್ತಿದೆ';
      case 'hi':
        return '$radius किमी के भीतर $traderType दिखा रहे हैं';
      case 'pa':
        return '$radius ਕਿਲੋਮੀਟਰ ਦੇ ਅੰਦਰ $traderType ਦਿਖਾ ਰਹੇ ਹਾਂ';
      case 'bn':
        return '$radius কিমি এর মধ্যে $traderType দেখাচ্ছে';
      case 'gu':
        return '$radius કિમીની અંદર $traderType બતાવી રહ્યા છે';
      case 'mr':
        return '$radius किमी मध्ये $traderType दाखवत आहे';
      case 'te':
        return '$radius కి.మీ. పరిధిలో $traderType చూపిస్తోంది';
      case 'ta':
        return '$radius கி.மீ. க்குள் $traderType காட்டுகிறது';
      default:
        return 'Showing $traderType within $radius km';
    }
  }
  ...
  String get couldNotLaunchMaps {
    switch (locale.languageCode) {
      case 'ml':
        return 'മാപ്സ് ആപ്ലിക്കേഷൻ തുറക്കാനായില്ല';
      case 'kn':
        return 'ನಕ್ಷೆ ಅಪ್ಲಿಕೇಶನ್ ತೆರೆಯಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ';
      case 'hi':
        return 'मैप्स एप्लिकेशन खोल नहीं सका';
      case 'pa':
        return 'ਨਕਸ਼ੇ ਐਪਲੀਕੇਸ਼ਨ ਖੋਲ੍ਹ ਨਹੀਂ ਸਕਿਆ';
      case 'bn':
        return 'মানচিত্র অ্যাপ্লিকেশন খুলতে পারেনি';
      case 'gu':
        return 'નકશા એપ્લિકેશન ખોલી શક્યું નહીં';
      case 'mr':
        return 'नकाशे अॅप्लिकेशन उघडू शकले नाही';
      case 'te':
        return 'మ్యాప్స్ అప్లికేషన్ తెరవలేకపోయింది';
      case 'ta':
        return 'வரைபடப் பயன்பாட்டைத் திறக்க முடியவில்லை';
      default:
        return 'Could not launch maps application';
    }
  }
  ...
  String get landSizeAndBudget {
    switch (locale.languageCode) {
      case 'ml':
        return 'ഭൂമിയുടെ വലുപ്പവും ബജറ്റും';
      case 'kn':
        return 'ಭೂಮಿ ಗಾತ್ರ ಮತ್ತು ಬಜೆಟ್';
      case 'hi':
        return 'भूमि का आकार और बजट';
      case 'pa':
        return 'ਜ਼ਮੀਨ ਦਾ ਆਕਾਰ ਅਤੇ ਬਜਟ';
      case 'bn':
        return 'জমির আকার এবং বাজেট';
      case 'gu':
        return 'જમીનનું કદ અને બજેટ';
      case 'mr':
        return 'जमीन आकार आणि बजेट';
      case 'te':
        return 'భూమి పరిమాణం మరియు బడ్జెట్';
      case 'ta':
        return 'நில அளவு மற்றும் பட்ஜெட்';
      default:
        return 'Land Size & Budget';
    }
  }
  ...
  String get plantingMonth {
    switch (locale.languageCode) {
      ...
      case 'hi':
        return 'रोपण माह';
      case 'pa':
        return 'ਬੀਜਣ ਦਾ ਮਹੀਨਾ';
      case 'bn':
        return 'রোপণের মাস';
      case 'gu':
        return 'વાવણીનો મહિનો';
      case 'mr':
        return 'लागवड महिना';
      case 'te':
        return 'నాటడం నెల';
  ...
  String get selectPlantingMonth {
    switch (locale.languageCode) {
      case 'ml':
        return 'നടീൽ മാസം തിരഞ്ഞെടുക്കുക';
      case 'kn':
        return 'ನೆಡುವ ತಿಂಗಳನ್ನು ಆಯ್ಕೆಮಾಡಿ';
      case 'hi':
        return 'रोपण माह चुनें';
      case 'pa':
        return 'ਬੀਜਣ ਦਾ ਮਹੀਨਾ ਚੁਣੋ';
      case 'bn':
        return 'রোপণের মাস নির্বাচন করুন';
      case 'gu':
        return 'વાવણીનો મહિનો પસંદ કરો';
      case 'mr':
        return 'लागवड महिना निवडा';
      case 'te':
        return 'నాటడం నెలను ఎంచుకోండి';
      case 'ta':
        return 'நடவு மாதத்தைத் தேர்ந்தெடுக்கவும்';
      default:
        return 'Select planting month';
    }
  }
  ...
  String get fertilizerRecommendation {
    switch (locale.languageCode) {
      case 'ml':
        return 'വള ശുപാർശ';
      case 'kn':
        return 'ಗೊಬ್ಬರ ಶಿಫಾರಸು';
      case 'hi':
        return 'उर्वरक की सिफारिश';
      case 'pa':
        return 'ਖਾਦ ਦੀ ਸਿਫਾਰਸ਼';
      case 'bn':
        return 'সার সুপারিশ';
      case 'gu':
        return 'ખાતરની ભલામણ';
  ...
  String get lateriteSoil {
    switch (locale.languageCode) {
      case 'ml':
        return 'ലാറ്ററൈറ്റ് മണ്ണ്';
      case 'kn':
        return 'ಲ್ಯಾಟರೈಟ್ ಮಣ್ಣು';
      case 'hi':
        return 'लैटेराइट मिट्टी';
      case 'pa':
        return 'ਲੈਟਰਾਈਟ ਮਿੱਟੀ';
      case 'bn':
        return 'ল্যাটেরাইট মাটি';
      case 'gu':
        return 'લેટેરાઇટ માટી';
      case 'mr':
        return 'लॅटेराईट माती';
      case 'te':
        return 'లాటరైట్ మట్టి';
      case 'ta':
        return 'லேட்டரைட் மண்';
      default:
  ...
  String get coastalSandy {
    switch (locale.languageCode) {
      ...
      case 'pa':
        return 'ਤਟਵਰਤੀ ਰੇਤਲੀ';
      case 'bn':
        return 'উপকূলীয় বালুকাময়';
      case 'gu':
        return 'દરિયાકાંઠાની રેતાળ';
      case 'mr':
        return 'किनारी वालुकामय';
      case 'te':
        return 'తీరప్రాంత ఇసుక';
      case 'ta':
        return 'கடலோர மணல்';
      default:
  ...
  String get redClaySoil {
    switch (locale.languageCode) {
      case 'ml':
        return 'ചുവന്ന കളിമണ്ണ്';
      case 'kn':
        return 'ಕೆಂಪು ಜೇಡಿ ಮಣ್ಣು';
      case 'hi':
        return 'लाल मिट्टी';
      case 'pa':
        return 'ਲਾਲ ਮਿੱਟੀ';
      case 'bn':
        return 'লাল কাদা মাটি';
      case 'gu':
        return 'લાલ માટી';
      case 'mr':
        return 'लाल माती';
  ...
  String get beachAreaSoil {
    switch (locale.languageCode) {
      case 'ml':
        return 'കടൽത്തീര മണ്ണ്';
      case 'kn':
        return 'ಕಡಲತೀರದ ಮಣ್ಣು';
      case 'hi':
        return 'समुद्र तटीय मिट्टी';
      case 'pa':
        return 'ਸਮੁੰਦਰੀ ਤੱਟ ਦੀ ਮਿੱਟੀ';
      case 'bn':
        return 'সৈকত অঞ্চলের মাটি';
      case 'gu':
        return 'બીચ વિસ્તારની માટી';
      case 'mr':
        return 'समुद्रकिनारा माती';
      case 'te':
        return 'తీర ప్రాంత మట్టి';
      case 'ta':
        return 'கடற்கரை பகுதி மண்';
      default:
        return 'Beach area soil';
    }
  }
  ...
  String get hillAreaSoil {
    switch (locale.languageCode) {
      case 'ml':
        return 'മലയോര മണ്ണ്';
      case 'kn':
        return 'ಬೆಟ್ಟದ ಪ್ರದೇಶದ ಮಣ್ಣು';
      case 'hi':
        return 'पहाड़ी क्षेत्र की मिट्टी';
      case 'pa':
        return 'ਪਹਾੜੀ ਖੇਤਰ ਦੀ ਮਿੱਟੀ';
      case 'bn':
        return 'পাহাড়ী এলাকার মাটি';
      case 'gu':
        return 'ટેકરી વિસ્તારની માટી';
      case 'mr':
        return 'डोंगराळ प्रदेशाची माती';
      case 'te':
        return 'కొండ ప్రాంత మట్టి';
      case 'ta':
        return 'மலைப் பகுதி மண்';
      default:
        return 'Hill area soil';
    }
  }
  ...
  String get currentLocation {
    switch (locale.languageCode) {
      ...
      case 'gu':
        return 'વર્તમાન સ્થાન';
      case 'mr':
        return 'सध्याचे स्थान';
      case 'te':
        return 'ప్రస్తుత స్థానం';
      case 'ta':
  ...
  String get waterAvailability {
    switch (locale.languageCode) {
      ...
      case 'hi':
        return 'जल उपलब्धता';
      case 'pa':
        return 'ਪਾਣੀ ਦੀ ਉਪਲਬਧਤਾ';
      case 'bn':
        return 'জল প্রাপ্যতা';
      case 'gu':
        return 'પાણીની ઉપલબ્ધતા';
      case 'mr':
        return 'पाणी उपलब्धता';
      case 'te':
        return 'నీటి లభ్యత';
      case 'ta':
        return 'நீர் இருப்பு';
  ...
  String get gettingWeather {
    switch (locale.languageCode) {
      case 'ml':
        return 'കാലാവസ്ഥ ലഭിക്കുന്നു...';
      case 'kn':
        return 'ಹವಾಮಾನ ಪಡೆಯಲಾಗುತ್ತಿದೆ...';
      case 'hi':
        return 'मौसम की जानकारी मिल रही है...';
      case 'pa':
        return 'ਮੌਸਮ ਦੀ ਜਾਣਕਾਰੀ ਪ੍ਰਾਪਤ ਕੀਤੀ ਜਾ ਰਹੀ ਹੈ...';
      case 'bn':
        return 'আবহাওয়া তথ্য পাওয়া যাচ্ছে...';
      case 'gu':
        return 'હવામાન મેળવી રહ્યા છીએ...';
      case 'mr':
        return 'हवामान माहिती मिळवत आहे...';
      case 'te':
        return 'వాతావరణ సమాచారం పొందుతోంది...';
      case 'ta':
        return 'வானிலை பெறப்படுகிறது...';
      default:
  ...
  String get pleaseFillAllFields {
    switch (locale.languageCode) {
      case 'ml':
        return 'ദയവായി എല്ലാ ഫീൽഡുകളും പൂരിപ്പിക്കുക';
      case 'kn':
        return 'ದಯವಿಟ್ಟು ಎಲ್ಲಾ ಕ್ಷೇತ್ರಗಳನ್ನು ಭರ್ತಿ ಮಾಡಿ';
      case 'hi':
        return 'कृपया सभी फील्ड भरें';
      case 'pa':
        return 'ਕਿਰਪਾ ਕਰਕੇ ਸਾਰੇ ਖੇਤਰ ਭਰੋ';
      case 'bn':
        return 'অনুগ্রহ করে সমস্ত ক্ষেত্র পূরণ করুন';
      case 'gu':
        return 'કૃપા કરીને બધા ક્ષેત્રો ભરો';
      case 'mr':
        return 'कृपया सर्व फील्ड भरा';
      case 'te':
        return 'దయచేసి అన్ని ఫీల్డ్‌లను పూరించండి';
      case 'ta':
        return 'அனைத்து புலங்களையும் நிரப்பவும்';
      default:
  ...
  String get noRecommendationAvailable {
    switch (locale.languageCode) {
      case 'ml':
        return 'ശുപാർശകൾ ലഭ്യമല്ല';
      case 'kn':
        return 'ಶಿಫಾರಸು ಲಭ್ಯವಿಲ್ಲ';
      case 'hi':
        return 'सिफारिश उपलब्ध नहीं';
      case 'pa':
        return 'ਸਿਫਾਰਸ਼ ਉਪਲਬਧ ਨਹੀਂ';
      case 'bn':
        return 'সুপারিশ উপলব্ধ নয়';
      case 'gu':
        return 'ભલામણ ઉપલબ્ધ નથી';
      case 'mr':
        return 'शिफारस उपलब्ध नाही';
      case 'te':
        return 'సిఫార్సు అందుబాటులో లేదు';
      case 'ta':
        return 'பரிந்துரை கிடைக்கவில்லை';
      default:
  ...
  String get errorGettingRecommendation {
    switch (locale.languageCode) {
      case 'ml':
        return 'ശുപാർശ ലഭിക്കുന്നതിൽ പിശക്. ദയവായി വീണ്ടും ശ്രമിക്കുക.';
      case 'kn':
        return 'ಶಿಫಾರಸು ಪಡೆಯುವಲ್ಲಿ ದೋಷ. ದಯವಿಟ್ಟು ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.';
      case 'hi':
        return 'सिफारिश प्राप्त करने में त्रुटि। कृपया पुनः प्रयास करें।';
      case 'pa':
        return 'ਸਿਫਾਰਸ਼ ਪ੍ਰਾਪਤ ਕਰਨ ਵਿੱਚ ਗਲਤੀ। ਕਿਰਪਾ ਕਰਕੇ ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ।';
      case 'bn':
        return 'সুপারিশ পেতে ত্রুটি। অনুগ্রহ করে আবার চেষ্টা করুন।';
      case 'gu':
        return 'ભલામણ મેળવવામાં ભૂલ. કૃપા કરીને ફરી પ્રયાસ કરો.';
      case 'mr':
        return 'शिफारस मिळवण्यात त्रुटी. कृपया पुन्हा प्रयत्न करा.';
      case 'te':
        return 'సిఫార్సు పొందడంలో లోపం. దయచేసి మళ్లీ ప్రయత్నించండి.';
      case 'ta':
        return 'பரிந்துரை பெறுவதில் பிழை. மீண்டும் முயற்சிக்கவும்.';
      default:
        return 'Error getting recommendation. Please try again.';
    }
  }
  ...
  String get failedToSaveData {
    switch (locale.languageCode) {
      case 'ml':
        return 'ഡാറ്റ സംരക്ഷിക്കുന്നതിൽ പരാജയപ്പെട്ടു';
      case 'kn':
        return 'ಡೇಟಾ ಉಳಿಸಲು ವಿಫಲವಾಗಿದೆ';
      case 'hi':
        return 'डेटा सहेजने में विफल';
      case 'pa':
        return 'ਡਾਟਾ ਸੁਰੱਖਿਅਤ ਕਰਨ ਵਿੱਚ ਅਸਫਲ';
      case 'bn':
        return 'ডেটা সংরক্ষণ করতে ব্যর্থ';
      case 'gu':
        return 'ડેટા સાચવવામાં નિષ્ફળ';
      case 'mr':
        return 'डेटा जतन करण्यात अयशस्वी';
      case 'te':
        return 'డేటాను సేవ్ చేయడంలో విఫలమైంది';
      case 'ta':
        return 'தரவைச் சேமிக்க முடியவில்லை';
      default:
  ...
  String get welcomeBack {
    switch (locale.languageCode) {
      case 'ml':
        return 'തിരിച്ചു വരവ്,';
      case 'kn':
        return 'ಮರಳಿ ಸ್ವಾಗತ,';
      case 'hi':
        return 'वापस स्वागत है,';
      case 'pa':
        return 'ਵਾਪਸ ਜੀ ਆਇਆਂ ਨੂੰ,';
      case 'bn':
        return 'ফিরে আসার স্বাগতম,';
      case 'gu':
        return 'પાછા સ્વાગત છે,';
      case 'mr':
        return 'परत स्वागत आहे,';
      case 'te':
        return 'తిరిగి స్వాగతం,';
      case 'ta':
        return 'மீண்டும் வரவேற்கிறோம்,';
      default:
        return 'Welcome back,';
    }
  }
  ...
  String get quickActions {
    switch (locale.languageCode) {
      case 'ml':
        return 'വേഗത്തിലുള്ള പ്രവർത്തനങ്ങൾ';
      case 'kn':
        return 'ತ್ವರಿತ ಕ್ರಿಯೆಗಳು';
      case 'hi':
        return 'त्वरित कार्य';
      case 'pa':
        return 'ਤੇਜ਼ ਕਾਰਵਾਈਆਂ';
      case 'bn':
        return 'দ্রুত কাজ';
      case 'gu':
        return 'ઝડપી ક્રિયાઓ';
  ...
  String get chatWithFarmers {
    switch (locale.languageCode) {
      case 'ml':
        return 'കർഷകരുമായി ചാറ്റ് ചെയ്യുക';
      case 'kn':
        return 'ರೈತರೊಂದಿಗೆ ಚಾಟ್ ಮಾಡಿ';
      case 'hi':
        return 'किसानों से चैट करें';
      case 'pa':
        return 'ਕਿਸਾਨਾਂ ਨਾਲ ਗੱਲਬਾਤ ਕਰੋ';
      case 'bn':
        return 'কৃষকদের সাথে চ্যাট করুন';
      case 'gu':
        return 'ખેડૂતો સાથે ચેટ કરો';
      case 'mr':
        return 'शेतकऱ्यांशी चॅट करा';
      case 'te':
        return 'రైతులతో చాట్ చేయండి';
      case 'ta':
        return 'விவசாயிகளுடன் அரட்டை';
      default:
        return 'Chat with Farmers';
    }
  }
  ...
  String get latestNews {
    switch (locale.languageCode) {
      case 'ml':
        return 'ഏറ്റവും പുതിയ വാർത്തകൾ';
      case 'kn':
        return 'ಇತ್ತೀಚಿನ ಸುದ್ದಿ';
      case 'hi':
        return 'नवीनतम समाचार';
      case 'pa':
        return 'ਤਾਜ਼ਾ ਖ਼ਬਰਾਂ';
      case 'bn':
        return 'সর্বশেষ খবর';
